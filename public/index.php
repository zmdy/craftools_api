...
$validPages = ['login', 'logout', 'dashboard', 'users', 'tokens', 'grid_sizes', 'album_templates', 'assets', 'phrases', 'phrases_csv_import', 'phrase_collections', 'bulk_import', 'upload_links', 'emoji_kitchen', 'api_logs', 'calendar_dates', 'calendar_dates_csv_import', 'calendar_dates_api_import'];
