...
$navItems = [
    ...
    ['key' => 'upload_links', 'icon' => 'link', 'label' => 'Links de Upload'],
    ['key' => 'assets', 'icon' => 'image', 'label' => 'Overlays & Fundos'],
    ['key' => 'shapes', 'icon' => 'category', 'label' => 'Shapes'],
    ['key' => 'fonts', 'icon' => 'font_download', 'label' => 'Fontes'],
...
$pageTitles = [
    ...
    'upload_links' => ['Links de Upload', 'Links de envio de fotos para clientes'],
    'assets' => ['Overlays & Fundos', 'Coleções de imagens de overlay e background'],
    'shapes' => ['Shapes', 'Packs de shapes SVG extra servidos via API'],
    'fonts' => ['Fontes', 'Catálogo de famílias e arquivos de fonte (TTF, OTF, WOFF, WOFF2)'],
